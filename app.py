...
def main():
    ...
    with col1: 
        with st.expander(" i Information", expanded=True):
            st.write("""
    ...
    st.warning("Note: This A.I application is for educational/demo purposes only and cannot be relied upon. Check the source code [here](https://github.com/karthi234231/Crop-Recomendation)")
    hide_menu_style = """
    <style>
